...
def fitTracks(trackCandidates, TFConstants):
    '''Calculates track fits using paper "Linear Fit within Missing-Hit Roads in FTKSim" by Annovi et al.
    and returns [[[best track coordinates], [fit params], chi2]...], where [best track coordinates] = []
    if there are too few layers in all candidates.'''
    ...
    for trackInfo in trackCandidates:
        ...
        bestTracks.append([bestTrack, bestTrackParameters, bestFitQualityEstimator])
